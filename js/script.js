    ...
    methods: {
        mostrarCreditos() {
            Swal.fire({
                ...
                html: `Bienvenido </a>
                <br>
                <strong>Memorama clasificatoria<br>El jugador escoge dos cartas, si las dos que escogió son iguales,
                 obtendrá un acierto que se mostrara en la parte superior izquierda y tiene derecho a escoger otras dos; 
                 si las dos cartas que escogió son diferentes automáticamente las cartas se voltean y se marcaran los intentos fallados, 
                 procura recordar cuales cartas eran ya que solo cuentas con 8 intentos </br></strong>
                <br>
